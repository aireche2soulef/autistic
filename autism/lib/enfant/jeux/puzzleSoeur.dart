...
class PuzzleSOEUR extends StatefulWidget {
  @override
  _PuzzleSOEURState createState() => _PuzzleSOEURState();
}

class _PuzzleSOEURState extends State<PuzzleSOEUR> {
  List<int> order =
